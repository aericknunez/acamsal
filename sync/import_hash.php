...
$archivos = glob("/home/superpol/public_html/pizto.com/acamsal/sync/database/*.sql");  
  foreach($archivos as $data){ 

  	$data = str_replace("/home/superpol/public_html/pizto.com/acamsal/sync/database/", "", $data);
  	$hash = str_replace(".sql", "", $data);

    $archx = "/home/superpol/public_html/pizto.com/acamsal/sync/database/" . $data;            
