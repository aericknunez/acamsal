...
$data =  file_get_contents('https://pizto.com/acamsal/application/includes/db_sync_json.php?x=' . $_SESSION["temporal_td"]); 
...
///////// actualizar el root
$data =  file_get_contents('https://pizto.com/acamsal/application/includes/root_json.php?x=' . $_SESSION["temporal_td"]); 
